...
/*
  Generated class for the ItemCalendarReturnUser page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-item-calendar-return-user',
  templateUrl: 'item-calendar-return-user.html'
})
export class ItemCalendarReturnUserPage {
    eventSource;
    viewTitle;
    isToday: boolean;
